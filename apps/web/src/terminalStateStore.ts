...
import { parseScopedThreadKey, scopedThreadKey } from "@bcode/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@bcode/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "bcode:terminal-state:v1";
