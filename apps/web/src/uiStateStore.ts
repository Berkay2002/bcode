...
const PERSISTED_STATE_KEY = "bcode:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "bcode:renderer-state:v8",
  "bcode:renderer-state:v7",
  "bcode:renderer-state:v6",
  "bcode:renderer-state:v5",
  "bcode:renderer-state:v4",
  "bcode:renderer-state:v3",
