...
export const CLIENT_SETTINGS_STORAGE_KEY = "bcode:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "bcode:saved-environment-registry:v1";
