...
import { type FilesystemBrowseInput, type ProjectEntry } from "@bcode/contracts";
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@bcode/shared/path";
import {
  insertRankedSearchResult,
  normalizeSearchQuery,
  scoreQueryMatch,
  type RankedSearchResult,
} from "@bcode/shared/searchRanking";
